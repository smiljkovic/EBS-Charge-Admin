...
@section('scripts')
    ...
    <script>
        ...
        $(document).on('click', '.download-user-report', function () {
            ...
            var headerArray = ['Type', 'Name', 'Email', 'PhoneNumber', 'Wallet Amount', 'Status'];
            var headers = [];
            ...
            if (type != "") {
                userRef = userRef.where('role', '==', type);
            }

            if (status == "true") {
                userRef = userRef.where('isActive', '==', true);
            } else if (status == "false") {
                userRef = userRef.where('isActive', '==', false);
            }
        ...
        async function getData(querySnapshot) {
            ...
            await Promise.all(querySnapshot.docs.map(async (doc) => {
                ...
                var newUserObj = {};
                newUserObj['Type'] = (userObj.role) ? userObj.role : "";
