                    ...
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{!! url('/faq/save') !!}"><i
                                            class="fa fa-plus mr-2"></i>{{trans('lang.faq_create')}}</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function getListData(val) {
            ...
            html = html + '<td class="action-btn"><a href="' + route1 + '"><i class="fa fa-edit"></i></a><a id="' + val.id + '" class="do_not_delete" name="faq-delete" href="javascript:void(0)"><i class="fa fa-trash"></i></a></td>';
            html = html + '</tr>';
