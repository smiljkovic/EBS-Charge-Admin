            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a
                            href="{!! route('charging-facilities') !!}">{{trans('lang.facility_plural')}}</a>
                    </li>
            ...
            <div class="card pb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group col-12 text-center btm-btn">
                        ...
                        <a href="{!! route('charging-facilities') !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{
                        trans('lang.cancel')}}</a>
                    </div>
                ...
                requestId == ''
                    ? storeImageData().then(IMG => {
                        database.collection('facilities').doc(id).set({
                            ...
                            window.location.href = '{{ route("charging-facilities")}}';
