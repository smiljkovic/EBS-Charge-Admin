                        ...
                        <div class="restaurant_payout_create-inner">
                            <fieldset>
                                ...
                                <div class="form-group row width-50">
                                    <label class="col-5 control-label">{{trans('lang.currency_name')}}<span
                                ...
                                <div class="form-group row width-50">
                                    <label class="col-5 control-label">{{trans('lang.currency_code')}}<span
                                            class="required-field"></span></label>
                                    <div class="col-7">
                                ...
                                <div class="form-group row width-50">
                                    <label class="col-5 control-label">{{trans('lang.currency_symbol')}}<span
                                            class="required-field"></span></label>
                                    <div class="col-7">
                                ...
                                <div class="form-group row width-50">
                                    <label class="col-5 control-label">{{trans('lang.digit_after_decimal_point')}}<span
                                            class="required-field"></span></label>
                                    <div class="col-7">
                                        <input type="number" class="form-control decimal_degits" value="0">
                                        <div
                                            class="form-text text-muted">{{trans('lang.digit_after_decimal_point_help')}}</div>
                                    </div>
                                </div>
