        ...
        <div class="card">
            <div class="payment-top-tab mt-3 mb-3">
                <ul class="nav nav-tabs card-header-tabs align-items-end">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active cod_active_label" href="{!! url('settings/payments/cod') !!}"><i
                    ...
                    <div class="restaurant_payout_create-inner">
                        <fieldset>
                            ...
                            <div class="form-group row width-100">
                                ...
                                <div class="col-7">
                                    <input type="file" class=" col-7 form-control cod-image"
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            paymentRef.get().then(async function (paymentSnapshots) {
                ...
                if (cash.hasOwnProperty('image')) {

                    if (cash.image != '' && cash.image != null) {
                        $(".payment_image").append('<span class="image-item"><span class="remove-btn"><i class="fa fa-remove"></i></span><img class="rounded" style="width:50px" src="' + cash.image + '" alt="image"></span>');
                        photo = cash.image;
                        ImageFile = cash.image;
                    } else {
                        photo = "";
                    }
                }
        ...
        $(".save_cod_btn").click(function () {
            ...
            storeImageData().then(IMG => {
                database.collection('settings').doc("payment").update({
                    'cash.enable': isCODEnabled,
                    'cash.image': IMG
                }).then(function (result) {
                    window.location.href = '{{ url("settings/payments/cod")}}';
                });
            }).catch(err => {
                jQuery("#overlay").hide();
                $(".error_top").show();
