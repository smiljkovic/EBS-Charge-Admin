                    ...
                    <div class="restaurant_payout_create-inner">
                        <fieldset>
                            ...
                            <div class="form-group row width-100">
                                <label class="col-3 control-label">{{trans('lang.app_setting_paypal_client')}}</label>
                                <div class="col-7">
                                    <input type="password" class=" form-control paypal_client">
                                    <div class="form-text text-muted">
                                        {!! trans('lang.app_setting_paypal_client_help') !!}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row width-100">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            paymentRef.get().then(async function (paymentSnapshots) {
                ...
                $('.paypal_client').val(payment.paypalClient);
        ...
        $(".save_paypal_btn").click(function () {
            ...
            var paypal_client = $(".paypal_client").val();
            ...
            storeImageData().then(IMG => {
                database.collection('settings').doc("payment").update({
                    ...
                    'paypal.paypalClient': paypal_client,
