        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{$id==''? trans('lang.add_language') :
                    trans('lang.edit_languages')}}
                    </li>
                </ol>
            </div>
        </div>
                ...
                (requestId == '') ?
                    ...
                    : (storeImageData().then(async IMG => {
                        ...
                        if (active) {
                            ...
                            await database.collection('languages').where('enable', "==", true).get().then(async function (snapshots) {
                                var activeLanguages = snapshots.docs[0].data();
                                var activeLanguagesId = activeLanguages.id;
                                if (snapshots.docs.length == 1 && activeLanguagesId == requestId) {
                                    checkFlag = true;
