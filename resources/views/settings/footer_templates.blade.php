        ...
        <div class="container-fluid">
            <div class="card">
                        ...
                        <div class="restaurant_payout_create-inner">
                            <fieldset>
                                ...
                                <div class="form-group width-100">
                                    <textarea class="form-control col-7" name="footerTemplate"
                                              id="footerTemplate"></textarea>
                                </div>
                ...
                <div class="form-group col-12 text-center btm-btn">
                    ...
                    <a href="{!! route('settings.footerTemplate') !!}" class="btn btn-default"><i
        ...
        $(".create_footer_btn").click(function () {
            ...
            if (footerTemplate == '') {
                ...
                database.collection('settings').doc('footerTemplate').update({'footerTemplate': footerTemplate}).then(function (result) {
                    window.location.href = '{{ route("settings.footerTemplate")}}';
                })
